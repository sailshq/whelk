...
module.exports = function whelk(optsOrMachineDef){
  ...
  if (machineDef.isWetMachine || machineDef.name==='_callableMachineWrapper') {
    ...
    var scriptIdentity =  machineDef.identity || (machineDef.friendlyName ? _.kebabCase(machineDef.friendlyName) : 'anonymous-whelk');
  ...
  var _originalExecBeforeItWasChangedForUseByMachinewhelk = liveMachine.exec;
  liveMachine.exec = function (argumentPassedToExec) {
    ...
    (function _doSetupMaybe (proceed){
      ...
      _originalExecBeforeItWasChangedForUseByMachinewhelk.apply(liveMachine, [function (sbErr, successResult){
